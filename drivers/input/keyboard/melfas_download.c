...
//#include "M340K_R10_V03_bin.c"
//#include "M340K_R10_V04_bin.c"
//#include "M340K_R13_V05_bin.c"
//#include "M340K_R13_V06_bin.c"
//#include "M340K_R13_V07_bin.c"
//#include "M340K_R15_V09_bin.c"
//#include "M340K_R15_V10_bin.c"
//#include "M340K_R15_V11_bin.c"
//#include "M340K_R15_V12_bin.c"
//#include "M340K_R15_V13_bin.c"
#include "M340K_R16_V15_bin.c"
...
*/	
	...
	//while(!gpio_get_value(KEY_SCL));
	delay_count = 100000;
	while(delay_count--)
	{
		if(gpio_get_value(KEY_SCL))
			break;
		udelay(1);
	}
	...
	while(cLength--)
	{
		*pData = 0;
		for (i = 8; i > 0; i--) {
			...
			EXT_I2C_SCL_HIGH;
			udelay(EXT_I2C_DELAY);
			*pData |= (!!(gpio_get_value(KEY_SDA)) << (i - 1));
			EXT_I2C_SCL_HIGH;
			udelay(EXT_I2C_DELAY);
			EXT_I2C_SCL_LOW;
			udelay(EXT_I2C_DELAY);
...
//
//============================================================
//#define KEY_INT S3C_GPIOINT(J4,1)
//#define KEY_INT IRQ_GPIOINT
...
int mcsdl_download_binary_data(UINT8 chip_ver)
{
...
#endif        
    if(MCS_VERSION==MCS5080_CHIP) //MCS-5080
	{
	...
	set_irq_type(KEY_INT, IRQ_TYPE_EDGE_FALLING);
	*/
...
static int mcsdl_i2c_prepare_program(void)
{
	...
	if( bRet == FALSE || ucTemp != MCSDL_I2C_ACK_PREPARE_PROGRAM)
		goto MCSDL_I2C_PREPARE_PROGRAM_FINISH;
