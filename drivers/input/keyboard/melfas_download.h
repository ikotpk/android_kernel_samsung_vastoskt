...
#define TKEY_VDD_SET_HIGH()             			gpio_direction_output(KEY_LED_33V, 1);					//
#define TKEY_VDD_SET_LOW()              			gpio_direction_output(KEY_LED_33V, 0);					//
#else
...
#define TKEY_INTR_SET_HIGH()             			gpio_direction_output(KEY_INT, 1);					//OT_INTR_SET_HIGH()
#define TKEY_INTR_SET_LOW()              			gpio_direction_output(KEY_INT, 0);					//OT_INTR_SET_LOW()
#define TKEY_INTR_SET_OUTPUT()             			//s3c_gpio_cfgpin(KEY_INT, GPIO_OUTPUT);					//OT_INTR_SET_OUTPUT()
#define TKEY_INTR_SET_INPUT()             			gpio_direction_input(KEY_INT);					//OT_INTR_SET_INPUT()
#else
...
#define TKEY_I2C_SCL_SET_HIGH()					gpio_direction_output(KEY_SCL, 1);						//OT_SCL_HIGH()
#define TKEY_I2C_SCL_SET_LOW()						gpio_direction_output(KEY_SCL, 0);						//OT_SCL_LOW()

#define TKEY_I2C_SDA_SET_HIGH()					gpio_direction_output(KEY_SDA, 1);						//OT_SDA_HIGH()
#define TKEY_I2C_SDA_SET_LOW()						gpio_direction_output(KEY_SDA, 0);						//OT_SDA_LOW()

#define TKEY_I2C_SCL_SET_OUTPUT()					//s3c_gpio_cfgpin(KEY_SCL, GPIO_OUTPUT);					//OT_SCL_SET_OUTPUT()
#define TKEY_I2C_SCL_SET_INPUT()					gpio_direction_input(KEY_SCL);					//OT_SCL_SET_INPUT()

#define TKEY_I2C_SDA_SET_OUTPUT()					//s3c_gpio_cfgpin(KEY_SDA, GPIO_OUTPUT);						//OT_SDA_SET_OUTPUT()
#define TKEY_I2C_SDA_SET_INPUT()					gpio_direction_input(KEY_SDA);					//OT_SDA_SET_INPUT()
